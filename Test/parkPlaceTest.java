...
public class parkPlaceTest {
  ...
  public void parkingManager_ShouldParkCar(){
       ...
       ParkingManager parkingManager =new ParkingManager(parkPlaces, new RandomParkingLotChooser());
       Ticket ticket1 = parkingManager.parking(car1);
       parkPlaceIndex = ticket1.parkPlaceIndex;
       Assert.assertSame(car1, parkingManager.GetParkedCar(ticket1));

       ticket1 = parkingManager.parking(car1);
       Assert.assertSame(car1, parkingManager.GetParkedCar(ticket1));
       Assert.assertNotSame(parkPlaceIndex,ticket1.parkPlaceIndex);
   }
}
